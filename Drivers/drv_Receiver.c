...
static void Virtual_Receive_Handler( unsigned int Task_ID );
...
void init_drv_Receiver()
{
    ...
    /*PPM*/
    STS_Add_Task( STS_Task_Trigger_Mode_RoughTime, 1.0f / 20, 0, Virtual_Receive_Handler );
...
static void Virtual_Receive_Handler( unsigned int Task_ID )
{
    ...
    rc_buf[4]=0;
    rc_buf[5]=0;
    Receiver_Update( RC_Type_Virtual, true, rc_buf, 6 );
}