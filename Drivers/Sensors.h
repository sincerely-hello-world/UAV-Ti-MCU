...
extern const unsigned char  default_laser_sensor_index;
...
extern const unsigned char default_vision_position_index;
extern const unsigned char default_vision_velocity_index;
/*位置传感器定义*/
