...
void init_Configurations()
{
	...
	//Yaw参数表
	float AC_Yaw_TD4P4_G9       =     25;     //航向角TD滤波器系数4
	float AC_Yaw_TD4P3_G9       =     25;     //航向角TD滤波器系数3
	float AC_Yaw_TD4P2_G9       =     10;     //航向角TD滤波器系数2
	float AC_Yaw_TD4P1_G9       =     25;     //航向角TD滤波器系数1
	
	float AC_Yaw_P4_G9          =     15;     //航向角Butterworth滤波器系数4
	float AC_Yaw_P3_G9          =     15;     //航向角Butterworth滤波器系数3
	float AC_Yaw_P2_G9          =     15;     //航向角Butterworth滤波器系数2
	float AC_Yaw_P1_G9          =     15;     //航向角Butterworth滤波器系数1
	
	float AC_Yaw_b_G9           =     1;      //航向角控制系数b<主调>
	//Yaw参数表
	
	//Pitch参数表
	float AC_Pitch_TD4P4_G9     =     25;     //俯仰角TD滤波器系数4
	float AC_Pitch_TD4P3_G9     =     25;     //俯仰角TD滤波器系数3
	float AC_Pitch_TD4P2_G9     =     25;     //俯仰角TD滤波器系数2
	float AC_Pitch_TD4P1_G9     =     25;     //俯仰角TD滤波器系数1
	
	float AC_Pitch_P4_G9        =     15;     //俯仰角Butterworth滤波器系数4
	float AC_Pitch_P3_G9        =     15;     //俯仰角Butterworth滤波器系数3
	float AC_Pitch_P2_G9        =     15;     //俯仰角Butterworth滤波器系数2
	float AC_Pitch_P1_G9        =     15;     //俯仰角Butterworth滤波器系数1
	
	float AC_Pitch_b_G9         =     5.5;    //俯仰角控制系数b<主调>
	//Pitch参数表
	
	//Roll参数表
	float AC_Roll_TD4P4_G9      =     25;     //翻滚角TD滤波器系数4
	float AC_Roll_TD4P3_G9      =     25;     //翻滚角TD滤波器系数3
	float AC_Roll_TD4P2_G9      =     25;     //翻滚角TD滤波器系数2
	float AC_Roll_TD4P1_G9      =     25;     //翻滚角TD滤波器系数1
	
	float AC_Roll_P4_G9         =     15;     //翻滚角Butterworth滤波器系数4
	float AC_Roll_P3_G9         =     15;     //翻滚角Butterworth滤波器系数3
	float AC_Roll_P2_G9         =     15;     //翻滚角Butterworth滤波器系数2
	float AC_Roll_P1_G9         =     15;     //翻滚角Butterworth滤波器系数1
	
	float AC_Roll_b_G9          =     5.5;    //翻滚角控制系数b<主调>
	//Roll参数表
	
	//电池参数表
	float BAT_VADCMag_G9        =     23*0.75;     //ADC电压值
	float BAT_STVoltage_G9      =     12.6;   //标准电压值<主调>   3S
	//float BAT_STVoltage_G9      =   16.8;   //标准电压值<主调>   4S
	//电池参数表
	
	//电机参数
	float MT_T_G9               =     0.1;    //油门满转系数
	float MT_FullThrR_G9        =     0.95;   //最大油门占比
	float MT_NonlinF_G9         =     0.65;   //非线性参数<主调>    //重的话调大
	float MT_STThr_G9           =     12;     //起转油门<主调>      //重的话调大一点
	//电机参数	
	
	//UAV设置
	float UAV_Type_G9           =     10;     //飞行器类型 - X翼型 10
	//UAV设置
	
	//参数写入
	//无人机机型参数写入
	Param_set_UAVType(UAV_Type_G9);
	//无人机机型参数写入
	
	//无人机电机参数写入
	Param_set_MotorStartingThrottle(MT_STThr_G9);
	Param_set_MotorNonlineFactor(MT_NonlinF_G9);
	Param_set_MotorFullThrottleRatio(MT_FullThrR_G9);
	Param_set_MotorT(MT_T_G9);
	//无人机电机参数写入
	
	//无人机电池参数写入
	Param_set_BatSTVoltage(BAT_STVoltage_G9);
	Param_set_BatVADCMag(BAT_VADCMag_G9);
	//无人机电池参数写入
	
	//无人机姿态环控制参数写入
	//Roll
	Param_set_RollCtrl_b(AC_Roll_b_G9);
	Param_set_RollCtrl_P1(AC_Roll_P1_G9);
	Param_set_RollCtrl_P2(AC_Roll_P2_G9);
	Param_set_RollCtrl_P3(AC_Roll_P3_G9);
	Param_set_RollCtrl_P4(AC_Roll_P4_G9);
	Param_set_RollCtrl_TD4P1(AC_Roll_TD4P1_G9);
	Param_set_RollCtrl_TD4P2(AC_Roll_TD4P2_G9);
	Param_set_RollCtrl_TD4P3(AC_Roll_TD4P3_G9);
	Param_set_RollCtrl_TD4P4(AC_Roll_TD4P4_G9);
	//Roll
	
	//Pitch
	Param_set_PitchCtrl_b(AC_Pitch_b_G9);
	Param_set_PitchCtrl_P1(AC_Pitch_P1_G9);
	Param_set_PitchCtrl_P2(AC_Pitch_P2_G9);
	Param_set_PitchCtrl_P3(AC_Pitch_P3_G9);
	Param_set_PitchCtrl_P4(AC_Pitch_P4_G9);
	Param_set_PitchCtrl_TD4P1(AC_Pitch_TD4P1_G9);
	Param_set_PitchCtrl_TD4P2(AC_Pitch_TD4P2_G9);
	Param_set_PitchCtrl_TD4P3(AC_Pitch_TD4P3_G9);
	Param_set_PitchCtrl_TD4P4(AC_Pitch_TD4P4_G9);
	//Pitch
	
	//Yaw
	Param_set_YawCtrl_b(AC_Yaw_b_G9);
	Param_set_YawCtrl_P1(AC_Yaw_P1_G9);
	Param_set_YawCtrl_P2(AC_Yaw_P2_G9);
	Param_set_YawCtrl_P3(AC_Yaw_P3_G9);
	Param_set_YawCtrl_P4(AC_Yaw_P4_G9);
	Param_set_YawCtrl_TD4P1(AC_Yaw_TD4P1_G9);
	Param_set_YawCtrl_TD4P2(AC_Yaw_TD4P2_G9);
	Param_set_YawCtrl_TD4P3(AC_Yaw_TD4P3_G9);
	Param_set_YawCtrl_TD4P4(AC_Yaw_TD4P4_G9);
	//Yaw
	//无人机姿态环控制参数写入
