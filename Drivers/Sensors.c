...
const unsigned char default_vision_sensor_index = 4; //独一无二的ID 越小越可信，越稳定,融合时优先级越高
const unsigned char default_vision_height_sensor_index = 7;
const unsigned char default_vision_position_index = 0;
const unsigned char default_vision_velocity_index = 8;
/*位置传感器注册函数*/
...
bool PositionSensorUpdatePositionGlobal( unsigned char index, vector3_double position_Global, bool available, float delay, float xy_trustD, float z_trustD )
{
    if( index >= Position_Sensors_Count )
        return false;
    Position_Sensor* sensor = &Position_Sensors[index];
...
bool PositionSensorUpdatePositionGlobalVel( unsigned char index, vector3_double position_Global, vector3_float vel, bool available, float delay, float xy_trustD, float z_trustD )
{
    if( index >= Position_Sensors_Count )
        return false;
    Position_Sensor* sensor = &Position_Sensors[index];
...
bool PositionSensorUpdatePositionVel( unsigned char index, vector3_float position, vector3_float vel, bool available, float delay, float xy_trustD, float z_trustD )
{
    if( index >= Position_Sensors_Count )
        return false;
    Position_Sensor* sensor = &Position_Sensors[index];
...
bool PositionSensorUpdateVel( unsigned char index, vector3_float vel, bool available, float delay, float xy_trustD, float z_trustD )
{
    if( index >= Position_Sensors_Count )
        return false;
    Position_Sensor* sensor = &Position_Sensors[index];
