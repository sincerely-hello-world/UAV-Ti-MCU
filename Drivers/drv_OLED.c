...
static inline void OLED_DC_LOW() {
    GPIOPinWrite(GPIOF_BASE, GPIO_PIN_4, 0);
}
static inline void OLED_DC_HIGH() {
    GPIOPinWrite(GPIOF_BASE, GPIO_PIN_4, GPIO_PIN_4);
}

static inline void OLED_RST_LOW() {
    GPIOPinWrite(GPIOE_BASE, GPIO_PIN_3, 0);
}
static inline void OLED_RST_HIGH() {
    GPIOPinWrite(GPIOE_BASE, GPIO_PIN_3, GPIO_PIN_3);
}
...
void init_drv_OLED()
{
    ...
    FDraw_Font16x8( OLED_Image, "SHU", 0, 64 );
    FDraw_Font16x8( OLED_Image, "1.0.0", 2, 100 );
    OLED_Update();
}
